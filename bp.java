...
public class bp extends javax.swing.JFrame {
    ...
    private void fetch(){
      ...
      try (Connection conn = DriverManager.getConnection(url);
           ...
           ResultSet rs = stmt.executeQuery("SELECT * FROM ALL_AVA")) {

         // create a table model from the result set
         DefaultTableModel model = (DefaultTableModel)btab.getModel();
    ...
    private void initComponents() {
        ...
        btab = new javax.swing.JTable();

        setDefaultCloseOperation(javax.swing.WindowConstants.EXIT_ON_CLOSE);
        setTitle("Available Peripherals");
        setResizable(false);
        ...
        btab.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
        ...
        jScrollPane1.setViewportView(btab);
    ...
    private javax.swing.JTable btab;
